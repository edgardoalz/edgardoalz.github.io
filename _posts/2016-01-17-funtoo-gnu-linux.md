...
Durante casi 10 años llevo utilizando sistemas operativos [GNU](http://www.gnu.org/)/[Linux](http://www.linux.org/), empezando desde los más sencillos de instalar como [Ubuntu](http://www.ubuntu.com/), [Fedora](https://getfedora.org/), entre otros y el estar pasando de **distribución** en distribución me ha servido para ir aprendiendo cada vez más a manejar este tipo de sistemas tipo **Unix**.

![GNU/Linux](/img/gnu-linux.png)

Ultimamente tenia instalado [Arch Linux](https://www.archlinux.org/), y estaba bastante contento con este, con diferentes entornos de escritorio como [Gnome](https://www.gnome.org), [Xfce](https://www.xfce.org) e incluso manejadores de ventana como [Openbox](https://www.openbox.org), asi fui mejorando mi manejo de la **terminal** y los archivos de configuración del sistema, hasta llegar a utilizar el [Arch Build System](https://wiki.archlinux.org/index.php/Arch_Build_System) para **compilar** algunos de los paquetes como el propio **kernel** para obtener un mejor rendimiento.
